    ...
    <section class="page-content">
      <div class="container">
        <div class="user-info-page">
          <h1 class="page-title">تاريخ الطلب</h1>
          <div class="row">
            <div class="col-lg-8">
              <form class="date-filter">
                <div class="date-line">
                  ...
                  <button type="submit" class="secondary-btn filter-btn">
                    تصفية
                  </button>
                </div>
              ...
              <div class="order-list">
                <a href="receipt" class="order-item">
                  <div class="item-img">
                  ...
                  <div class="item-text">
                    <div class="desc-items">
                        ...
                        <div class="desc-item">
                            إجمالي المدفوعات
                            <strong>140 ريال</strong>
                        </div>
                        <div class="desc-item">
                            تاريخ الشراء
                            <strong>30/3/2022</strong>
                        </div>
                    </div>
                ...
                <a href="receipt" class="order-item">
                  <div class="item-img">
                    <img src="images/products/03.jpg" class="img-fluid" />
                  </div>
                  <div class="item-text">
                    <div class="desc-items">
                        <div class="desc-item">
