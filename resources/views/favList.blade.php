    ...
    <section class="breadcrumb-section">
      <div class="container">
        <ol class="breadcrumb">
          ...
          <li class="active">بطاقاتك المفضلة</li>
        </ol>
      </div>
    </section>
    <!-- End Breadcrumb -->
    ...
    <section class="page-content">
      <div class="container">
        <div class="user-info-page">
          <h1 class="page-title">بطاقاتك المفضلة</h1>
          <div class="row">
            <div class="col-lg-9">
              <div class="fav-grid">
                <div class="grid-item">
                ...
                <div class="grid-item">
                  <div class="product">
                    ...
                    <div class="product-tools">
                      <span class="unavailable"> البطاقة غير متوفره </span>
                    </div>
                  </div>
                </div>
                <div class="grid-item">
      ...
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          ...
          <p class="confirm-text">
            هل أنت متأكد من أنك تريد حذف هذه البطاقة من المفضلة ؟
          </p>
