    ...
    <section class="breadcrumb-section">
      <div class="container">
        <ol class="breadcrumb">
          ...
          <li class="active">تفاصيل الحساب</li>
        </ol>
      </div>
    </section>
    <!-- End Breadcrumb -->
    ...
    <section class="page-content">
      <div class="container">
        <div class="user-info-page">
          <h1 class="page-title">
            تفاصيل الحساب
            <button class="edit-info primary-btn" onclick="edit(this)">
              <i class="las la-edit"></i>
              تعديل
            </button>
            <div class="edit-btns">
              <button class="edit-info secondary-btn">
                <i class="las la-save"></i>
                حفظ
              </button>
              <button class="edit-info default-btn">
          ...
          <div class="row">
              ...
              <div class="form-block">
                ...
                <div class="form-line">
                  <div class="form-group">
                    ...
                    <input
                      type="text"
                      class="form-control info-input editable"
                      disabled
                      value="بسام العميري"
                    />
                  </div>
                  <div class="form-group">
                    ...
                    <input
                      ...
                      class="form-control info-input editable"
                      disabled
                      value="bassam.alomari@gmail.com"
                    />
                  </div>
                </div>
                <div class="form-line">
                  <div class="form-group">
                    ...
                    <select class="form-control info-input" disabled>
                ...
                <div class="form-line">
                  <div class="form-group">
                    ...
                    <div class="input-date">
                      <input
                        type="text"
                        class="form-control info-input form-flatpickr"
                        value="2016-10-10"
                        disabled
                      />
                      <i class="las la-calendar date-icon"></i>
                    </div>
                  </div>
                  <div class="form-group">
                    <label> المدينة </label>
                  ...
                  <div class="checkbox">
                    <label>
                      <input
                        ...
                        class="info-input editable"
                      />
                      <span class="mark"><i class="las la-check"></i></span>
                      الألعاب
                    </label>
                  </div>
                  <div class="checkbox">
            ...
            <div class="col-lg-4">
              <div class="side-links">
                ...
                <a href="editPassword" class="side-link">
