...
<html dir="rtl" lang="ar">
  ...
  <body>
    ...
    <section class="breadcrumb-section">
      <div class="container">
        <ol class="breadcrumb">
          ...
          <li class="active">طريقة الشراء</li>
        </ol>
      </div>
    </section>
    <!-- End Breadcrumb -->
    ...
    <section class="page-content">
      <div class="container">
        <h1 class="page-title">طريقة الشراء</h1>
        <div class="howToBuy-content">
          <div class="row">
            <div class="col-xl-5">
              <h6>شرح الخطوات</h6>
              <ol class="list-unstyled">
                <li>ندخل على موقع بطاقاتي</li>
                <li>نختار القسم والمنتج</li>
                <li>نختار القيمة التي نريدها</li>
                <li>نضغط على إتمام عملية الشراء</li>
              </ol>
              <h6>في حال عدم التسجيل</h6>
              <ol class="list-unstyled">
                <li>نضغط إنشاء حساب مجاني</li>
                <li>
                  سنقوم بمليء البيانات أولًا الأسم يكون على الأقل ثنائي
                  <br />
                  ثانياً البريد الإلكتروني
                  <br />
                  ثالثاً كلمة المرور تكون باللغة الإنجليزية تحتوي على الأقل 8
                  أحرف وتحتوي على حرف كبير ورقم واحد على الأقل
                  <br />
                  رابعا نعيد إدخال كلمة المرور مرة أخرى
                  <br />
                  خامسا نقوم بإدخال رقم جوال سعودي
                  <br />
                  سادسا نضغط على زر أنا لست برنامج روبوت
                </li>
                <li>نضغط على زر إنشاء حساب</li>
                <li>نضغط على إتمام عملية الشراء</li>
              </ol>
            </div>
            <div class="col-xl-7">
              <div class="howToBuy-video">
                <iframe
                  class="video"
