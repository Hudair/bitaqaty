          ...
          <div class="row">
                ...
                <div class="cart-item">
                  ...
                  <div class="receipt-table">
                    <div class="table-head">
                      ...
                      <div class="table-item">اسم المستخدم</div>
                      <div class="table-item">كلمة المرور</div>
                      <div class="table-item">الرقم التسلسلي</div>
                      <div class="table-item">باركود</div>
                    </div>
                    <div class="table-row">
                      <div class="table-item">
                        <span class="item-title">رقم الفاتورة</span>
                        <strong>27/02/2022</strong>
                      </div>
                      <div class="table-item">
                        <span class="item-title">اسم المستخدم</span>
                        <strong>username57070</strong>
                      </div>
                      <div class="table-item">
                        <span class="item-title">كلمة المرور</span>
                        <strong>password57070</strong>
                      </div>
                      <div class="table-item">
                        <span class="item-title">الرقم التسلسلي</span>
                        <strong>serial57070</strong>
                      </div>
                      <div class="table-item">
                        <span class="item-title">باركود</span>
                        <strong>
                          <img src="images/barcode.png" class="img-fluid" />
                        </strong>
                      </div>
                    </div>
                  </div>
            ...
            <div class="col-lg-4">
              ...
              <ul class="info-list list-unstyled">
                <li>
                  رقم الفاتورة
                  <strong>1645961294254309895</strong>
                </li>
                <li>
                  تاريخ الشراء
                  <strong>27/02/2022</strong>
              ...
              <div class="side-totals">
                <h2 class="page-title">إجمالي الفاتورة</h2>
                <div class="totals">
                  <div class="total">
