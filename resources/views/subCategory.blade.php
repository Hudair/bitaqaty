    ...
    <section class="breadcrumb-section">
      <div class="container">
        <ol class="breadcrumb">
          ...
          <li class="active">بلايستيشن ستور سعودي</li>
        </ol>
      </div>
    </section>
    <!-- End Breadcrumb -->
      ...
      <div class="container">
        <div class="subcategory-head">
          <div class="head-img">
            <div class="subcategory-img">
              <img src="./images/subcategory/01.jpg" class="img-fluid" />
            </div>
          </div>
          <div class="head-text">
            <h1 class="page-title">بلايستيشن ستور سعودي</h1>
            <div class="head-summary">
              <p class="page-p">
                حمِل كل ما تريد من ألعاب البلايستيشن والمحتوى الخاص بأي لعبة من
                بلايستيشن ستور من خلال شراء بطاقات بلايستيشن نتوورك المتجر
                السعودي. يمكن استخدام بطاقات بلايستيشن نتوورك المتجر السعودي على
                اجهزة PS4, PS3, PSP and PS Vita
              </p>
        ...
        <div class="suggested-products">
          <div class="products-head">
            <h2 class="products-title">ربما يعجبك أيضا</h2>
          </div>
